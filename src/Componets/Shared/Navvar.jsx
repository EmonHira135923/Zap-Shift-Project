...
const Navvbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Send Parcel", href: "/send-parcel" },
          ...
          {loading ? (
            ...
            <div ref={profileRef} className="hidden lg:block relative">
              <button
                ...
                className="w-10 h-10 rounded-full border-2 border-[#C6EB71] overflow-hidden hover:shadow-md transition-all focus:outline-none"
              >
                <Image
                  height={50}
                  width={50}
