const PaymentHistoryPageSkeleton = () => (
  <div className="max-w-7xl mx-auto p-4 sm:p-10 pb-24 min-h-screen bg-[#F8FAFC] animate-pulse">
    <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center">
        ...
        <div className="h-16 min-w-[140px] bg-[#002B36]/10 rounded-2xl"></div>
      </div>
    </div>
    <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
      {[...Array(6)].map((_, i) => (
        <div key={i} className="grid grid-cols-5 gap-4 px-6 py-5 border-b border-gray-50">
...
export default PaymentHistoryPageSkeleton;
