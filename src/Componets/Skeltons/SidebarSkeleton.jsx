      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-gray-100 px-6 md:px-10 flex items-center justify-between">
          <div className="flex items-center gap-4 animate-pulse">
             <div className="h-10 w-10 bg-gray-100 rounded-xl md:hidden"></div> {/* Mobile Toggle */}
          ...
          <div className="flex items-center gap-3 md:gap-5 animate-pulse">
            <div className="w-10 h-10 bg-gray-50 border border-gray-100 rounded-xl"></div> {/* Icon */}
            <div className="w-px h-6 bg-gray-100 hidden sm:block"></div> {/* Divider */}
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-10 space-y-8">
          ...
          {/* Large Content Section (Table/Chart) */}
