        ...
        <div className="md:w-5/12 bg-[#002B36] p-10 flex flex-col justify-between text-white">
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Log in to access your dashboard, track shipments, and manage your
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-[#002B36] uppercase ml-1">
                  Email Address
                </label>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center px-1">
                  <label className="text-xs font-bold text-[#002B36] uppercase">
                    Password
                  </label>
                  <Link
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink mx-4 text-gray-400 text-[10px] font-bold uppercase">
                Or continue with
              </span>
              <div className="flex-grow border-t border-gray-100"></div>
            </div>
            ...
            <p className="text-center text-gray-500 text-sm pt-2">
              ...
              <Link
                href="/auth/register"
                className="text-[#002B36] font-bold hover:underline"
              >
                Create Account
              </Link>
            </p>
